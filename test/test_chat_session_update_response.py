...
class TestChatSessionUpdateResponse(unittest.TestCase):
    """ChatSessionUpdateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatSessionUpdateResponse:
        """Test ChatSessionUpdateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatSessionUpdateResponse`
        """
        model = ChatSessionUpdateResponse()
        if include_optional:
    ...
    def testChatSessionUpdateResponse(self):
        """Test ChatSessionUpdateResponse"""

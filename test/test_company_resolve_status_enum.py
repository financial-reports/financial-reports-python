...
class TestCompanyResolveStatusEnum(unittest.TestCase):
    """CompanyResolveStatusEnum unit test stubs"""
    ...
    def testCompanyResolveStatusEnum(self):
        """Test CompanyResolveStatusEnum"""
        # inst = CompanyResolveStatusEnum()

...
class TestCompanyMergedInto(unittest.TestCase):
    """CompanyMergedInto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompanyMergedInto:
        """Test CompanyMergedInto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompanyMergedInto`
        """
        model = CompanyMergedInto()
        if include_optional:
            return CompanyMergedInto(
                id = 56,
                name = ''
            )
        else:
    ...
    def testCompanyMergedInto(self):
        """Test CompanyMergedInto"""

...
class TestPatchedChatSessionUpdateRequest(unittest.TestCase):
    """PatchedChatSessionUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchedChatSessionUpdateRequest:
        """Test PatchedChatSessionUpdateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedChatSessionUpdateRequest`
        """
        model = PatchedChatSessionUpdateRequest()
        if include_optional:
            return PatchedChatSessionUpdateRequest(
                title = ''
            )
        else:
            return PatchedChatSessionUpdateRequest(
    ...
    def testPatchedChatSessionUpdateRequest(self):
        """Test PatchedChatSessionUpdateRequest"""

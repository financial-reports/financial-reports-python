...
class TestCompanyResolveResult(unittest.TestCase):
    """CompanyResolveResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompanyResolveResult:
        """Test CompanyResolveResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompanyResolveResult`
        """
        model = CompanyResolveResult()
        if include_optional:
            return CompanyResolveResult(
                ...
                status = 'matched',
                resolved_via = 'isin',
                company = financial_reports_generated_client.models.company_resolve_match.CompanyResolveMatch(
                    id = 56, 
                    name = '', 
                    ticker = '', 
                    isins = [
    ...
    def testCompanyResolveResult(self):
        """Test CompanyResolveResult"""

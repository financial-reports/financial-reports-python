...
class TestChatInteractionRequest(unittest.TestCase):
    """ChatInteractionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatInteractionRequest:
        """Test ChatInteractionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatInteractionRequest`
        """
        model = ChatInteractionRequest()
        if include_optional:
    ...
    def testChatInteractionRequest(self):
        """Test ChatInteractionRequest"""

...
class TestPaginatedFilingHistoryList(unittest.TestCase):
    """PaginatedFilingHistoryList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedFilingHistoryList:
        """Test PaginatedFilingHistoryList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedFilingHistoryList`
        """
        model = PaginatedFilingHistoryList()
        if include_optional:
            return PaginatedFilingHistoryList(
                count = 123,
                next = 'http://api.example.org/accounts/?page=4',
                previous = 'http://api.example.org/accounts/?page=2',
                results = [
                    financial_reports_generated_client.models.filing_history.FilingHistory(
                        history_id = 56, 
    ...
    def testPaginatedFilingHistoryList(self):
        """Test PaginatedFilingHistoryList"""

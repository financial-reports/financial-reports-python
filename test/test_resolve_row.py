...
class TestResolveRow(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ResolveRow:
        """Test ResolveRow
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResolveRow`
        """
        model = ResolveRow()
        if include_optional:
            return ResolveRow(

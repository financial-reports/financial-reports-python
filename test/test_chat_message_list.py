...
class TestChatMessageList(unittest.TestCase):
    """ChatMessageList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatMessageList:
        """Test ChatMessageList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatMessageList`
        """
        model = ChatMessageList()
        if include_optional:
            return ChatMessageList(
                session_context = financial_reports_generated_client.models.session_context.SessionContext(
                    company_id = 56, 
                    company_name = '', 
                    filing_ids = [
                        56
                ...
                messages = [
                    financial_reports_generated_client.models.chat_message_item.ChatMessageItem(
                        id = 56, 
                        role = '', 
                        content = '', 
                        thought_signature = '', 

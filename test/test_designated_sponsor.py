...
class TestDesignatedSponsor(unittest.TestCase):
    """DesignatedSponsor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DesignatedSponsor:
        """Test DesignatedSponsor
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DesignatedSponsor`
        """
        model = DesignatedSponsor()
        if include_optional:
    ...
    def testDesignatedSponsor(self):
        """Test DesignatedSponsor"""

...
class TestMarkdownNotFound(unittest.TestCase):
    """MarkdownNotFound unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarkdownNotFound:
        """Test MarkdownNotFound
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarkdownNotFound`
        """
        model = MarkdownNotFound()
        if include_optional:

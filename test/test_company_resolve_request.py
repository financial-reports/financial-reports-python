...
class TestCompanyResolveRequest(unittest.TestCase):
    """CompanyResolveRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompanyResolveRequest:
        """Test CompanyResolveRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompanyResolveRequest`
        """
        model = CompanyResolveRequest()
        if include_optional:
            return CompanyResolveRequest(
                rows = [
                    financial_reports_generated_client.models.resolve_row.ResolveRow(
                        ref = '', 
                        isin = '', 
                        lei = '', 
                        cik = '', 
    ...
    def testCompanyResolveRequest(self):
        """Test CompanyResolveRequest"""

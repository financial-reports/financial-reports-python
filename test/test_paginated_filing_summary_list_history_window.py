...
class TestPaginatedFilingSummaryListHistoryWindow(unittest.TestCase):
    """PaginatedFilingSummaryListHistoryWindow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedFilingSummaryListHistoryWindow:
        """Test PaginatedFilingSummaryListHistoryWindow
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedFilingSummaryListHistoryWindow`
        """
        model = PaginatedFilingSummaryListHistoryWindow()
        if include_optional:
            return PaginatedFilingSummaryListHistoryWindow(
                limited = True,
                max_history_days = 56,
    ...
    def testPaginatedFilingSummaryListHistoryWindow(self):
        """Test PaginatedFilingSummaryListHistoryWindow"""

...
class TestCompaniesFinancialsRetrieve200ResponsePeriodsInnerStatementsInnerExtraction(unittest.TestCase):
    """CompaniesFinancialsRetrieve200ResponsePeriodsInnerStatementsInnerExtraction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompaniesFinancialsRetrieve200ResponsePeriodsInnerStatementsInnerExtraction:
        """Test CompaniesFinancialsRetrieve200ResponsePeriodsInnerStatementsInnerExtraction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompaniesFinancialsRetrieve200ResponsePeriodsInnerStatementsInnerExtraction`
        """
        model = CompaniesFinancialsRetrieve200ResponsePeriodsInnerStatementsInnerExtraction()
        if include_optional:
            return CompaniesFinancialsRetrieve200ResponsePeriodsInnerStatementsInnerExtraction(
                model = '',
                prompt_version = '',
    ...
    def testCompaniesFinancialsRetrieve200ResponsePeriodsInnerStatementsInnerExtraction(self):
        """Test CompaniesFinancialsRetrieve200ResponsePeriodsInnerStatementsInnerExtraction"""

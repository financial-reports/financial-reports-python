...
class TestCompanyResolveSummary(unittest.TestCase):
    """CompanyResolveSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompanyResolveSummary:
        """Test CompanyResolveSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompanyResolveSummary`
        """
        model = CompanyResolveSummary()
        if include_optional:
            return CompanyResolveSummary(
                matched = 56,
    ...
    def testCompanyResolveSummary(self):
        """Test CompanyResolveSummary"""

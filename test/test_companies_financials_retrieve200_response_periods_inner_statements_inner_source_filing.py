...
class TestCompaniesFinancialsRetrieve200ResponsePeriodsInnerStatementsInnerSourceFiling(unittest.TestCase):
    """CompaniesFinancialsRetrieve200ResponsePeriodsInnerStatementsInnerSourceFiling unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompaniesFinancialsRetrieve200ResponsePeriodsInnerStatementsInnerSourceFiling:
        """Test CompaniesFinancialsRetrieve200ResponsePeriodsInnerStatementsInnerSourceFiling
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompaniesFinancialsRetrieve200ResponsePeriodsInnerStatementsInnerSourceFiling`
        """
        model = CompaniesFinancialsRetrieve200ResponsePeriodsInnerStatementsInnerSourceFiling()
        if include_optional:
    ...
    def testCompaniesFinancialsRetrieve200ResponsePeriodsInnerStatementsInnerSourceFiling(self):
        """Test CompaniesFinancialsRetrieve200ResponsePeriodsInnerStatementsInnerSourceFiling"""

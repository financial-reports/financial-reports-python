...
class TestCompanyResolveViaEnum(unittest.TestCase):
    """CompanyResolveViaEnum unit test stubs"""
    ...
    def testCompanyResolveViaEnum(self):
        """Test CompanyResolveViaEnum"""
        # inst = CompanyResolveViaEnum()

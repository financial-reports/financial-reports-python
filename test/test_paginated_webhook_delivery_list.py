...
class TestPaginatedWebhookDeliveryList(unittest.TestCase):
    """PaginatedWebhookDeliveryList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedWebhookDeliveryList:
        """Test PaginatedWebhookDeliveryList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedWebhookDeliveryList`
        """
        model = PaginatedWebhookDeliveryList()
        if include_optional:
            return PaginatedWebhookDeliveryList(
                count = 123,
                next = 'http://api.example.org/accounts/?page=4',
                previous = 'http://api.example.org/accounts/?page=2',
                results = [
                    financial_reports_generated_client.models.webhook_delivery.WebhookDelivery(
                        uuid = '', 
                        webhook_id = 56, 
                        event_type = '', 
                        filing_id = 56, 
    ...
    def testPaginatedWebhookDeliveryList(self):
        """Test PaginatedWebhookDeliveryList"""

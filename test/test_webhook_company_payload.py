...
class TestWebhookCompanyPayload(unittest.TestCase):
    """WebhookCompanyPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookCompanyPayload:
        """Test WebhookCompanyPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookCompanyPayload`
        """
        model = WebhookCompanyPayload()
        if include_optional:
    ...
    def testWebhookCompanyPayload(self):
        """Test WebhookCompanyPayload"""

...
class TestIngestionModeEnum(unittest.TestCase):
    """IngestionModeEnum unit test stubs"""
    ...
    def testIngestionModeEnum(self):
        """Test IngestionModeEnum"""
        # inst = IngestionModeEnum()

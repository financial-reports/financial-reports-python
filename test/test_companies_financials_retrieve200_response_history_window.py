...
class TestCompaniesFinancialsRetrieve200ResponseHistoryWindow(unittest.TestCase):
    """CompaniesFinancialsRetrieve200ResponseHistoryWindow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompaniesFinancialsRetrieve200ResponseHistoryWindow:
        """Test CompaniesFinancialsRetrieve200ResponseHistoryWindow
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompaniesFinancialsRetrieve200ResponseHistoryWindow`
        """
        model = CompaniesFinancialsRetrieve200ResponseHistoryWindow()
        if include_optional:
            return CompaniesFinancialsRetrieve200ResponseHistoryWindow(
                limited = True,
                max_history_days = 56,
    ...
    def testCompaniesFinancialsRetrieve200ResponseHistoryWindow(self):
        """Test CompaniesFinancialsRetrieve200ResponseHistoryWindow"""

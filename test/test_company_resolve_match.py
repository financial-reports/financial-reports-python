...
class TestCompanyResolveMatch(unittest.TestCase):
    """CompanyResolveMatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompanyResolveMatch:
        """Test CompanyResolveMatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompanyResolveMatch`
        """
        model = CompanyResolveMatch()
        if include_optional:
    ...
    def testCompanyResolveMatch(self):
        """Test CompanyResolveMatch"""

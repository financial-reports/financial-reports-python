...
class TestChatApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_chat_sessions_share_create(self) -> None:
        """Test case for chat_sessions_share_create

        """
        pass

    async def test_chat_sessions_title_retrieve(self) -> None:
        """Test case for chat_sessions_title_retrieve

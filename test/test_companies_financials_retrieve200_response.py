    ...
    def make_instance(self, include_optional) -> CompaniesFinancialsRetrieve200Response:
        ...
        if include_optional:
            return CompaniesFinancialsRetrieve200Response(
                ...
                notice = '',
                history_window = financial_reports_generated_client.models.companies_financials_retrieve_200_response_history_window.companies_financials_retrieve_200_response_history_window(
                    limited = True, 
                    max_history_days = 56, 

...
class TestCompaniesFinancialsRetrieve200ResponsePeriodsInnerStatementsInner(unittest.TestCase):
    """CompaniesFinancialsRetrieve200ResponsePeriodsInnerStatementsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompaniesFinancialsRetrieve200ResponsePeriodsInnerStatementsInner:
        """Test CompaniesFinancialsRetrieve200ResponsePeriodsInnerStatementsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompaniesFinancialsRetrieve200ResponsePeriodsInnerStatementsInner`
        """
        model = CompaniesFinancialsRetrieve200ResponsePeriodsInnerStatementsInner()
        if include_optional:
            return CompaniesFinancialsRetrieve200ResponsePeriodsInnerStatementsInner(
                statement_type = 'IS',
    ...
    def testCompaniesFinancialsRetrieve200ResponsePeriodsInnerStatementsInner(self):
        """Test CompaniesFinancialsRetrieve200ResponsePeriodsInnerStatementsInner"""

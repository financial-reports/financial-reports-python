...
class CompanyResolveResponse(BaseModel):
    ...
    """ # noqa: E501
    summary: CompanyResolveSummary
    results: List[CompanyResolveResult]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "summary": CompanyResolveSummary.from_dict(obj["summary"]) if obj.get("summary") is not None else None,
            "results": [CompanyResolveResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj

...
class CurrencyCompact(BaseModel):
    """
    CurrencyCompact
    """ # noqa: E501
    code: Annotated[str, Field(strict=True, max_length=3)] = Field(description="ISO 4217 currency code (e.g., 'USD', 'EUR').")
    name: Annotated[str, Field(strict=True, max_length=100)] = Field(description="Common name of the currency (e.g., 'United States Dollar', 'Euro').")
    symbol: Optional[Annotated[str, Field(strict=True, max_length=5)]] = None

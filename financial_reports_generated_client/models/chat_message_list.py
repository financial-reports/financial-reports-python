...
class ChatMessageList(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["session_context", "messages"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of session_context
        if self.session_context:
            _dict['session_context'] = self.session_context.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "session_context": SessionContext.from_dict(obj["session_context"]) if obj.get("session_context") is not None else None,
            "messages": [ChatMessageItem.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None
        })
        return _obj

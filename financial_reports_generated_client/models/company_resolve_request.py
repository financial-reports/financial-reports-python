...
class CompanyResolveRequest(BaseModel):
    ...
    """ # noqa: E501
    rows: Annotated[List[ResolveRow], Field(min_length=1, max_length=500)] = Field(description="1-500 rows to reconcile.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rows": [ResolveRow.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
        return _obj

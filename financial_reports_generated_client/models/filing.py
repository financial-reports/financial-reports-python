...
class Filing(BaseModel):
    ...
    ingestion_mode: IngestionModeEnum = Field(description="How this filing entered the platform: REALTIME (picked up within the source's normal publication-to-availability window) or BACKFILLED (historical import, recovery, or bulk backfill).  * `REALTIME` - Realtime * `BACKFILLED` - Backfilled")

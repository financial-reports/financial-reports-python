...
class WebhookCreateResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "url", "is_active", "include_markdown", "include_isins", "track_all_companies", "trigger_on_filing_received", "trigger_on_filing_processed", "deliver_late_filings", "subscribed_filing_types", "created_at", "updated_at", "secret_key"]

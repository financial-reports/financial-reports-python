...
class Jurisdiction(BaseModel):
    ...
    Jurisdiction
    """ # noqa: E501
    code: StrictStr = Field(description="ISO 3166-1 or ISO 3166-2 jurisdiction code (e.g., GB, US-DE).")
    name: StrictStr = Field(description="Human-readable name of the jurisdiction.")

...
class EntityLegalForm(BaseModel):
    """
    EntityLegalForm
    """ # noqa: E501
    elf_code: StrictStr = Field(description="The 4-character ISO 20275 ELF code (e.g., XJHM).")
    name: StrictStr = Field(description="Human-readable name of the legal form.")
    __properties: ClassVar[List[str]] = ["elf_code", "name"]

...
class WebhookTestResponse(BaseModel):
    ...
    """ # noqa: E501
    status: StrictStr = Field(description="Delivery status of the test event (e.g. 'success', 'failed').")
    message: StrictStr = Field(description="Human-readable description of the test outcome.")
    delivery_uuid: UUID = Field(description="UUID of the delivery record created for this test.")
    __properties: ClassVar[List[str]] = ["status", "message", "delivery_uuid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "delivery_uuid": obj.get("delivery_uuid")
        })
        return _obj

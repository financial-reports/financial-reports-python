...
class ResolveRow(BaseModel):
    ...
    """ # noqa: E501
    ref: Optional[Annotated[str, Field(strict=True, max_length=200)]] = Field(default=None, description="Opaque client-supplied key, echoed back untouched so results can be joined to source rows. Must be unique within the batch if supplied. Results are also returned in input order.")

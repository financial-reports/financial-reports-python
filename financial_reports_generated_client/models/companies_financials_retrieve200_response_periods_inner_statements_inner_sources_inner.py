...
class CompaniesFinancialsRetrieve200ResponsePeriodsInnerStatementsInnerSourcesInner(BaseModel):
    """
    CompaniesFinancialsRetrieve200ResponsePeriodsInnerStatementsInnerSourcesInner
    """ # noqa: E501
    filing_id: Optional[StrictInt] = None
    filing_type: Optional[StrictStr] = None
    release_datetime: Optional[datetime] = None
    is_selected: Optional[StrictBool] = Field(default=None, description="Exactly one entry per statement is the selected one.")
    __properties: ClassVar[List[str]] = ["filing_id", "filing_type", "release_datetime", "is_selected"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if filing_type (nullable) is None
        # and model_fields_set contains the field
        if self.filing_type is None and "filing_type" in self.model_fields_set:
            _dict['filing_type'] = None

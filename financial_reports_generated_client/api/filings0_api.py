...
class FilingsApi:
    ...
    @validate_call
    async def filings_live_pulse_retrieve(
        self,
        ...
        Last-N filings JSON for the homepage live-pulse globe.  Public, throttled, cached 30s server-side. Filters out pre-publication filings and any filing whose company has no ISO mapping in frontend_src/data/markets-latlng.json.
        ...
        _param = self._filings_live_pulse_retrieve_serialize(
    ...
    @validate_call
    async def filings_live_pulse_retrieve_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def filings_live_pulse_retrieve_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _filings_live_pulse_retrieve_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/filings/live-pulse/',

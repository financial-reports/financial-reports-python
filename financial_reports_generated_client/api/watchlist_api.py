...
class WatchlistApi:
    ...
    @validate_call
    async def watchlist_companies_bulk_add_create(
        self,
        bulk_watchlist: BulkWatchlist,
        ...
        **Access Level Required:** Requires **Standard Access (Level 1)**.  --- Adds up to 100 companies to the authenticated user's watchlist in a single request. Companies already in the watchlist are silently skipped.

        :param bulk_watchlist: (required)
        :type bulk_watchlist: BulkWatchlist
        ...
        _param = self._watchlist_companies_bulk_add_create_serialize(
    ...
    @validate_call
    async def watchlist_companies_bulk_add_create_with_http_info(
        self,
        bulk_watchlist: BulkWatchlist,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BulkWatchlistResponse]:
        """Bulk Add Companies to Watchlist
    ...
    @validate_call
    async def watchlist_companies_bulk_add_create_without_preload_content(
        self,
        bulk_watchlist: BulkWatchlist,
        _request_timeout: Union[
            None,
    ...
    def _watchlist_companies_bulk_add_create_serialize(
        self,
        bulk_watchlist,
        _request_auth,
        _content_type,
        ...
        if bulk_watchlist is not None:
            _body_params = bulk_watchlist
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/watchlist/companies/bulk-add/',
    ...
    @validate_call
    async def watchlist_companies_bulk_remove_create(
        self,
        bulk_watchlist: BulkWatchlist,
        _request_timeout: Union[
            None,
        ...
        **Access Level Required:** Requires **Standard Access (Level 1)**.  --- Removes up to 100 companies from the authenticated user's watchlist in a single request. Companies not in the watchlist are silently skipped.
        ...
        _param = self._watchlist_companies_bulk_remove_create_serialize(
            bulk_watchlist=bulk_watchlist,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def watchlist_companies_bulk_remove_create_with_http_info(
        self,
        bulk_watchlist: BulkWatchlist,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def watchlist_companies_bulk_remove_create_without_preload_content(
        self,
        bulk_watchlist: BulkWatchlist,
        _request_timeout: Union[
            None,
    ...
    def _watchlist_companies_bulk_remove_create_serialize(
        self,
        bulk_watchlist,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/watchlist/companies/bulk-remove/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

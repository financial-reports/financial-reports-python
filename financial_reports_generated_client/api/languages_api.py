...
class LanguagesApi:
    ...
    async def languages_list(
        ...
        **Access Level Required:** Requires **Standard Access (Level 1)**.  --- Retrieve a list of all supported languages for filings.
    ...
    async def languages_retrieve(
        ...
        **Access Level Required:** Requires **Standard Access (Level 1)**.  --- Retrieve details for a specific language by its ID.

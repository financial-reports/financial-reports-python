...
class SecurityListingsApi:
    ...
    @validate_call
    async def security_listings_list(
        self,
        company: Optional[Union[StrictFloat, StrictInt]] = None,
        exch_code: Optional[StrictStr] = None,
        ...
        _param = self._security_listings_list_serialize(
            company=company,
            exch_code=exch_code,
            figi=figi,
            mic=mic,
    ...
    @validate_call
    async def security_listings_list_with_http_info(
        self,
        company: Optional[Union[StrictFloat, StrictInt]] = None,
        exch_code: Optional[StrictStr] = None,
        figi: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedSecurityListingList]:
        """List security listings (exchange + ticker per company)
    ...
    @validate_call
    async def security_listings_list_without_preload_content(
        self,
        company: Optional[Union[StrictFloat, StrictInt]] = None,
        exch_code: Optional[StrictStr] = None,
        figi: Optional[StrictStr] = None,
    ...
    def _security_listings_list_serialize(
        self,
        company,
        exch_code,
        figi,
        ...
        if exch_code is not None:
            ...
            _query_params.append(('exch_code', exch_code))
            
        if figi is not None:
            
            _query_params.append(('figi', figi))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/security-listings/',
    ...
    @validate_call
    async def security_listings_retrieve(
        self,
        id: Annotated[StrictInt, Field(description="A unique integer value identifying this security listing.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: A unique integer value identifying this security listing. (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._security_listings_retrieve_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def security_listings_retrieve_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="A unique integer value identifying this security listing.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def security_listings_retrieve_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="A unique integer value identifying this security listing.")],
        _request_timeout: Union[
            None,
    ...
    def _security_listings_retrieve_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/security-listings/{id}/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
